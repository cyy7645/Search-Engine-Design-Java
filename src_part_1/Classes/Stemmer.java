...
public class Stemmer {
	 ...
	 * 不需要给次添加一个字符，可以直接添加整个单词，当知道单词长度时
	 */
	...
	* */
	...
	/*
	 * cvc(i) is true <=> i-2,i-1,i has the form consonant - vowel - consonant 辅元辅
	 * and also if the second c is not w,x or y. this is used when trying to
	 * restore an e at the end of a short word. e.g.
	 *
	 * 当最后四个字符的前面三个是辅音-元音-辅音-其他组合，且第二个辅音不是w,x,y时，返回true
